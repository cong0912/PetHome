    ...
    return (
        <div className="navbar-header">
            ...
            <ul>
                ...
                >
                    <div className="dropdown-icon">Dịch Vụ <ArrowDropDownIcon /></div>
                    ...
                    {isDichVuOpen && (
                        <ul className="dropdown">
                            ...
                            >
                                <div className="dropdown-icon"> Spa Thú Cưng <ArrowDropDownIcon /></div>
                                {isSpaOpen && (
                                    <ul className="dropdown">
                            ...
                            >
                                <div className="dropdown-icon">Dịch Vụ Tại Nhà <ArrowDropDownIcon /></div>
                ...
                >
                    <div className="dropdown-icon">Cửa Hàng <ArrowDropDownIcon /></div>
                    ...
                    {isCuaHangOpen && (
                        <ul className="dropdown">
                            ...
                            >
                                <div className="dropdown-icon">Dành cho chó <ArrowDropDownIcon /></div>
                            ...
                            >
                                <div className="dropdown-icon"> Dành cho mèo <ArrowDropDownIcon /></div>
